...
#sprites
s1 = create_sprite("frenchie!", 100, 100)
s2 = create_sprite("chicken jockey", -100, -100)
s3 = create_sprite("soccer balls",-100, 100)
s4 = create_sprite("subway logo 2", 100, -100)

message1 = create_sprite("alien",-200,200)
message1.color("white")
message1.write("Alice",font = ("Arial", 40, "normal"))
message1.hideturtle()

message2 = create_sprite("alien",-200,-200)
message2.color("white")
message2.write("chicken is the best",font = ("Arial", 40, "normal"))
message2.hideturtle()
######################################################################
